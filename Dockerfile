...
LABEL maintainer="Nikhil Kumar (kumarn1@mskcc.org)" \
      ...
      source.neoantigenEditing="https://github.com/LukszaLab/NeoantigenEditing" \
      source.credit_doi="https://doi.org/10.1038/s41586-022-04735-9"

ENV NEOANTIGEN_EDITING_TAG CMO
...
RUN apt-get update \
  ...
  && cd /tmp \
  && git clone --branch ${NEOANTIGEN_EDITING_TAG} https://github.com/LukszaLab/NeoantigenEditing \
